...
def run_style_transfer(cnn, normalization_mean, normalization_std, content_img, style_img1, style_img2, input_img,
                       num_steps=150, style_weight1=50000, content_weight1=1):
    print('Building the style transfer model..')
    model, style_losses, content_losses = get_style_model_and_losses2(cnn, normalization_mean, normalization_std,
                                                                      style_img1, style_img2, content_img)
...
def do_transfer2(content_image_name1, style_image_name11, style_image_name21, n_iter1, style_weight1, content_weight1):
    ...
    output = run_style_transfer(cnn, cnn_normalization_mean, cnn_normalization_std,
                                content_image, style_image1, style_image2, input_img,
...
content_image_name = 'dog2'
style_image_name1 = 'winter'
style_image_name2 = 'anime2'
n_iter = 1000
style_weight = 500000
content_weight = 1
target_resolution = ()
result_image = do_transfer2(content_image_name, style_image_name1, style_image_name2,
                            n_iter, style_weight, content_weight)
result_image.save(fp=f'images/results/{content_image_name}_{style_image_name1}_{n_iter}.jpg')



# style_image_name = 'anime'
# n_iter = 500
# content_weight = 0.1
# result_image2 = do_transfer(content_image_name, style_image_name)
# result_image2.save(fp=images/results/{content_image_name}_{style_image_name}_{content_weight}_{n_iter}.jpg')
#
# smooth_factor = 1
# smooth_width = int(255/smooth_factor)
# mean_width = target_resolution[1] // 2
# mask = Image.new(mode='L', size=result_image.size, color=0)
# for i in range(1, smooth_width + 1):
#     for y in range(target_resolution[0]):
#         mask.putpixel((i + mean_width - smooth_width // 2, y), i*smooth_factor)
# mask_one = Image.new(mode='L',
#                      size=(result_image.size[0] - mean_width + smooth_width // 2 + 2, result_image.size[0]),
#                      color=255)
# mask.paste(mask_one, (mean_width + smooth_width // 2 + 1, 0))
#
# merged_image = Image.composite(result_image2, result_image, mask)
# plt.figure()
# plt.imshow(merged_image)
# plt.show()
# merged_image.save(fp='images/results/bundle.jpg')
